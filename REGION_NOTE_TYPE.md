...
The current plan is to derive locator maps and unlabeled division-membership maps from a single blank U.S. SVG whose state shapes are keyed by two-letter class abbreviations.
